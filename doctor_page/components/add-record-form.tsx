          ...
          <CardContent className="p-4 lg:p-6">
            ...
            <div ref={printRef} className="hidden">
              ...
              <div className="patient-info">
                ...
                <p><strong>Date:</strong> {new Date(savedRecord.date).toLocaleDateString("en-IN", { day: "numeric", month: "long", year: "numeric" })}</p>
              </div>

              <div className="section">
                <div className="section-title">Symptoms</div>
                <div className="section-content">{savedRecord.symptoms}</div>
              </div>

              <div className="section">
                <div className="section-title">Diagnosis</div>
                <div className="section-content">{savedRecord.diagnosis}</div>
              </div>

              <div className="section">
                <div className="section-title">Doctor&apos;s Advice</div>
                <div className="section-content">{savedRecord.doctorAdvice}</div>
              </div>
            ...
            <Card className="border-border/50 bg-muted/20">
              <CardContent className="p-4 lg:p-6 space-y-4">
                ...
                <div className="p-4 bg-background rounded-xl border border-border/50">
                  ...
                  <p className="text-sm text-foreground">{savedRecord.doctorAdvice}</p>
                </div>
                ...
                <div className="p-4 bg-gradient-to-r from-secondary/10 to-secondary/5 rounded-xl border border-secondary/20">
                  <p className="text-xs font-semibold text-secondary uppercase tracking-wide mb-3">
                    Prescription ({savedRecord.prescription.length} items)
                  </p>
